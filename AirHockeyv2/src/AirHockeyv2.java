...
// fixing so that you can open it in the laptop
 ...
 * @author baayl
 */
public class AirHockeyv2 extends JComponent implements KeyListener {
    ...
    public static void main(String[] args) {
        ...
        AirHockeyv2 game = new AirHockeyv2();
    ...
    public void keyPressed(KeyEvent ke) {
        ...
        // keys being pressed when moving paddle WSAD, â†�â†‘â†’â†“
    ...
    public void keyReleased(KeyEvent ke) {
        int key = ke.getKeyCode();
        // keys being released when moving paddle WSAD, â†�â†‘â†’â†“
        if (key == KeyEvent.VK_W) {
            redPaddleUp = false;
        } else if (key == KeyEvent.VK_S) {
            redPaddleDown = false;
